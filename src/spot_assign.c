...
//
//
// // simulating like 6-7 parking lots (more like 4) with 10 spots and parked space with numberplate
//
//
// int occupy[4][10] = {0};
...
//             spot = 'A'; spotIndex = 0; // hatchback
//         }
//         else if (carType[0] == 'S' || carType[0] == 's') {
//             spot = 'B'; spotIndex = 1; // sudan
//         }
//         else if (carType[0] == 'U' || carType[0] == 'u') {
//             spot = 'C'; spotIndex = 2; // suv
//         }
//         else if (carType[0] == 'E' || carType[0] == 'e') {
//             spot = 'E'; spotIndex = 3; // EV
//         }
//         else {
//             printf("Unknown car.\n");
//             continue;
